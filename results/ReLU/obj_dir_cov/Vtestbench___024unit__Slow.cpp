...
Vtestbench___024unit::Vtestbench___024unit() = default;
Vtestbench___024unit::~Vtestbench___024unit() = default;

void Vtestbench___024unit::ctor(Vtestbench__Syms* symsp, const char* namep) {
    vlSymsp = symsp;
...
void Vtestbench___024unit___configure_coverage(Vtestbench___024unit* vlSelf, bool first);

void Vtestbench___024unit::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    Vtestbench___024unit___configure_coverage(this, first);
}

void Vtestbench___024unit::dtor() {
    VL_DO_DANGLING(std::free(const_cast<char*>(vlNamep)), vlNamep);
}

// Coverage
void Vtestbench___024unit::__vlCoverInsert(uint32_t* countp, bool enable, const char* filenamep, int lineno, int column,
...
// Toggle Coverage
void Vtestbench___024unit::__vlCoverToggleInsert(int begin, int end, bool ranged, uint32_t* countp, bool enable, const char* filenamep, int lineno, int column,
