...
always @(*) begin
    for (j = 0; j < N_OUT; j = j + 1) begin
        result[j] = {{(ACC_WIDTH - DATA_WIDTH){bias[DATA_WIDTH-1]}}, bias}; //estende o bias de DATA_WIDTH para ACC_WIDTH, respeitando o sinal (repete o último elemento na extensão)
